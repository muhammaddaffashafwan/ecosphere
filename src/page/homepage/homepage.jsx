  ...
  return (
    <>
      <div className="home-page">
        ...
        "At Ecosmophere, we empower you with the knowledge to create an eco-friendly home.
         Explore smart solutions, sustainable practices, and practical tips to reduce your
          environmental footprint while enhancing your living space. Start your journey toward greener
           living today."
        </div>

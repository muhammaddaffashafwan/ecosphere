    ...
    <div className="bg-white min-h-screen text-black">
      <div className="absolute top-[100px] left-[20px] sm:left-[150px] w-full sm:w-[544.1px] h-auto sm:h-[411.8px] text-left text-black font-[Optician Sans]">
        <div className="discovery flex flex-col sm:flex-row items-center">
          <img className="absolute ml-0 mobile:w-[500px] mobile:ml-[450px] sm:ml-[605px] top-0 left-0 z-0 w-[200px] sm:w-[544px] h-auto" alt="Eco Discovery" src="assets/prop_illus.jpg" />
          <div className="mt-[-20px] tracking-[-0.02em] pt-[30px] leading-[20px] text-black px-4 sm:px-0">
            <h1 className="font-bold text-[32px] sm:text-[45px] text-justify sm:text-left">DISCOVER ECO-FRIENDLY HOMES AND PRODUCTS</h1>
      ...
      {/* Partners Section */}
      <div className=" relative top-[760px] left-[calc(50%-670px)] w-[1340px] flex flex-col items-center gap-[30px]">
      ...
      <div className="px-4 md:px-16 lg:px-24 pt-[900px] pb-[4px] gap-4 mt-4 flex-wrap">
        ...
        <h3 className="lg:ml-[100px] px-4 md:px-16 lg:px-24 font-medium text-black mt-6">Filter</h3>
      ...
      <section className="mb-[125px] container px-4 md:px-16 lg:px-24 py-4">
        <main className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 ml-[80px]">

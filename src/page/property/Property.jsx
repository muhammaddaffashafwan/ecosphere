  ...
  return (
    <div className="bg-white min-h-screen text-black">
        ...
        <div id="partnersCarousel" className="carousel slide relative">
          <div className="carousel-inner">
            ...
            <div className="carousel-item flex justify-center space-x-4">
              <img className="partner-logo w-auto h-16 mr-20" src="assets/.jpg" alt="Partner 2" />
              <img className="partner-logo w-auto h-16 mr-20" src="assets/.jpg" alt="Partner 3" />
      ...
      <div className="px-24 pt-[900px] pb-[4px] gap-4 mt-4 flex-wrap">
        <h1 className="text-center text-30 font-bold">PROPERTY RECOMMENDATION</h1>
